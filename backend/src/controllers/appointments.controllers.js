...
const getMaxActiveAppointments =
  async (client) => {
    const result =
      await client.query(`
        SELECT
...
export const createAppointment =
  async (req, res) => {
    ...
    try {
      ...
      const maxActiveAppointments =
        await getMaxActiveAppointments(
          client,
        );
        ...
        return res.status(409).json({
          ...
          message:
            ...
            1
              ...
              : `Ya alcanzaste el máximo de ${maxActiveAppointments} turnos activos permitidos.`,
